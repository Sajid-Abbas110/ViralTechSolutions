    ...
    <section className="relative py-24 lg:py-36 bg-gray-50 overflow-hidden">
      ...
      <div className="relative z-20 max-w-4xl mx-auto text-center px-6">
        ...
        <h2 className="text-4xl sm:text-5xl md:text-6xl font-extrabold leading-tight tracking-tight text-[#2c5e2b]">
          Your <span className="text-[#98bc62]">Innovate,</span>
          <br />
          <span className="text-[#98bc62]"> Integrate, and Succeed</span>
        </h2>

        <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto mb-10 leading-relaxed">
          Are you ready to integrate the solutions to thrive in the ecosystem?
        </p>

        {/* Green CTA Button */}
        <Link
            to={'/contact-us'}
          className="px-5 py-3 mt-10 border bg-[#2c5e2b] hover:border-[#2c5e2b] rounded-full text-sm text-[white] hover:bg-[#ffff] hover:text-[#2c5e2b] transition">
            Join Us
          </Link>
      </div>
