  ...
  return (
    <section className="relative py-24 lg:py-36 bg-gray-50 overflow-hidden">
      ...
      <div className="relative z-20  mx-auto text-center px-6">
        ...
        <h2 className="text-6xl sm:text-5xl md:text-6xl font-semibold leading-tight tracking-tight text-[#2c5e2b]">
          Make Your <span className="text-[#98bc62]"> Digital</span>
          <br />
          <span className="text-[#98bc62]"> Journey Work Out with ViralTechSolutions</span>
        </h2>

        <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
          ViralTechSolutions has been delivering websites for over a decade. Our process is effective and adheres to strict deadlines. We start with a detailed understanding of your thoughts and requirements. Once the project is completed, we ensure you aren’t just satisfied and can see the change in results after a limited time!
