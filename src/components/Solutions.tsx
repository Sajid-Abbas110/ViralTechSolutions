import { Square, Leaf, Heart, Shield } from "lucide-react"; // Updated imports to match new content
...
const valueCards: ValueCardData[] = [
  {
    ...
    title: "Integrity",
    description:
      "We adhere to the code of truthfulness and honesty to ensure consistency in our values.",
    color: "#34D399",
  },
  {
    icon: Leaf,
    title: "Innovation",
    description:
      "Our consultants provide innovative solutions that align with your business goals.",
    color: "#D1B44E",
  },
  {
    icon: Shield,
    title: "Dedication",
    description:
      "We commit ourselves to delivering exceptional results powered by the right strategies.",
    color: "#9333EA",
  },
  {
    icon: Heart,
    title: "Collaboration",
    description:
      "Together, we create synergy and build relationships on a foundation of understanding.",
    color: ACCENT_LIGHT,
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:items-center">
          ...
          <div className="lg:col-span-1 flex flex-col justify-center">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-[#2c5e2b] leading-tight mb-6">
              Build the Future With Our Innovative Digital Solutions
            </h2>

            <p className="text-gray-700 leading-relaxed mb-8 max-w-[600px]">
              We don’t just offer software — we build sustainable digital ecosystems
              that accelerate your enterprise growth. Whether you're in the USA,
              Florida, Dallas, California, or Texas, we help your business thrive
              with smart digital transformation.
            </p>

            {/* CTA BUTTON */}
           <Link
              to={"/contact-us"}
              className="px-5 py-3 border bg-[#2c5e2b] hover:border-[#2c5e2b] text-center rounded-full text-sm text-white hover:bg-[#ffff] hover:text-[#2c5e2b] transition w-[260px] md:w-[280px]"
            >
