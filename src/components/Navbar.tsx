    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div className="flex items-center space-x-2 cursor-pointer">
          <Link to={'/'} onClick={handleLinkClick}> <img src="/logo.png" alt="Logo" className="h-15 w-auto" /></Link>
        </div>

        {/* Desktop Menu */}
        <ul className="hidden md:flex items-center space-x-8 text-sm text-[#2c5e2b] font-medium">
          <li><Link to="/" className="hover:text-[#98bc62] transition" onClick={handleLinkClick}>Home</Link></li>
          <li><Link to="/about" className="hover:text-[#98bc62] transition" onClick={handleLinkClick}>About</Link></li>
          ...
          <li className="relative" ref={dropdownRef}>
            ...
            {openDropdown && (
              <ul className="absolute top-full left-0 mt-2 w-48 bg-white shadow-lg rounded-lg border border-gray-200 py-2 z-50">
                <li><Link to="/web-development" className="block px-4 py-2 hover:bg-[#98bc62] hover:text-white transition" onClick={handleLinkClick}>Web Development</Link></li>
                <li><Link to="/mobile-apps" className="block px-4 py-2 hover:bg-[#98bc62] hover:text-white transition" onClick={handleLinkClick}>Mobile Apps</Link></li>
                <li><Link to="/graphic-design" className="block px-4 py-2 hover:bg-[#98bc62] hover:text-white transition" onClick={handleLinkClick}>Graphic Design</Link></li>
              </ul>
            )}
          </li>

          <li><Link to="/portfolio" className="hover:text-[#98bc62] transition" onClick={handleLinkClick}>Portfolio</Link></li>
          <li><Link to="/our-team" className="hover:text-[#98bc62] transition" onClick={handleLinkClick}>Our Team</Link></li>
          <li><Link to="/contact-us" className="hover:text-[#98bc62] transition" onClick={handleLinkClick}>Contact</Link></li>
        </ul>
        ...
        <div className="md:hidden cursor-pointer" id="mobile-menu-toggle">
          <button onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)} aria-label="Toggle Mobile Menu">
            {isMobileMenuOpen ? (
              // Close Icon (X)
              <svg className="w-7 h-7 text-[#2c5e2b]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      ...
      >
        <ul className="flex flex-col space-y-4 px-6 py-4 text-[#2c5e2b] font-medium border-t border-gray-100">
            <li><Link to="/" className="block py-2 hover:text-[#98bc62] transition" onClick={handleLinkClick}>Home</Link></li>
            <li><Link to="/about" className="block py-2 hover:text-[#98bc62] transition" onClick={handleLinkClick}>About</Link></li>
            ...
            <li className="relative">
                ...
                {openDropdown && (
                    <ul className="pl-4 border-l border-[#98bc62] mt-2 space-y-2">
                        ...
                        <li><Link to="/web-development" className="block py-1 text-sm text-gray-600 hover:text-[#98bc62]" onClick={handleLinkClick}>Web Development</Link></li>
                        <li><Link to="/mobile-apps" className="block py-1 text-sm text-gray-600 hover:text-[#98bc62]" onClick={handleLinkClick}>Mobile Apps</Link></li>
                        <li><Link to="/graphic-design" className="block py-1 text-sm text-gray-600 hover:text-[#98bc62]" onClick={handleLinkClick}>Graphic Design</Link></li>
                    </ul>
                )}
            </li>

            <li><Link to="/portfolio" className="block py-2 hover:text-[#98bc62] transition" onClick={handleLinkClick}>Portfolio</Link></li>
            <li><Link to="/our-team" className="block py-2 hover:text-[#98bc62] transition" onClick={handleLinkClick}>Our Team</Link></li>
            <li><Link to="/contact-us" className="block py-2 hover:text-[#98bc62] transition" onClick={handleLinkClick}>Contact</Link></li>
        </ul>
