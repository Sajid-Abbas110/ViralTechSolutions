      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col lg:flex-row items-center lg:items-start">
        ...
        <div className="lg:w-1/2 mb-10 lg:mb-0 lg:pr-10 text-center lg:text-left">
          <h1 className="text-xl mt-20 md:text-5xl font-medium text-[#ffff] leading-tight my-6">
            VitalTechSolutions <br />
            Offers Graphic Design Solutions for Your Brand
          </h1>
        </div>
        ...
        <div className="lg:w-1/2 text-center mt-20 lg:text-left">
          <p className="text-lg sm:text-xl lg:text-2xl leading-relaxed">
            Here, the creative possibilities are endless. We take great pride in
            our highly skilled designers, who have helped create effective logos
            for major brands and raised the standard for design in places like
            the USA, Florida, Dallas, California, and Texas.
          </p>
        </div>
      </div>
